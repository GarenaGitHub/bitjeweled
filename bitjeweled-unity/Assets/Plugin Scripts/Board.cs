...
#region Private Members
    ...
    internal bool CheckTileMatchX (int x1, int y1, int x2, int y2, bool justCheck)
    {
        ...
        if ((gridDescriptor [x2, y2] != (int)TileType.NoTile) &&
            ...
            if (((x2 + 2) < columns) &&
                ...
                ((intGridDescriptor [x2, y2] == intGridDescriptor [x2 + 1, y2]) || PlayingPieces [x2 + 1, y2].Bomb) &&
                ((intGridDescriptor [x2, y2] == intGridDescriptor [x2 + 2, y2]) || PlayingPieces [x2 + 2, y2].Bomb)) {
                if (!justCheck &&
    ...
    internal bool CheckTileMatchX4 (int x1, int y1, int x2, int y2, bool justCheck)
    {
        ...
        if ((gridDescriptor [x2, y2] != (int)TileType.NoTile) &&
            ...
            if (((x2 + 3) < columns) &&
                ...
                ((intGridDescriptor [x2, y2] == intGridDescriptor [x2 + 1, y2]) || PlayingPieces [x2 + 1, y2].Bomb) &&
                ((intGridDescriptor [x2, y2] == intGridDescriptor [x2 + 2, y2]) || PlayingPieces [x2 + 2, y2].Bomb) &&
                ((intGridDescriptor [x2, y2] == intGridDescriptor [x2 + 3, y2]) || PlayingPieces [x2 + 3, y2].Bomb)) {
                if (!justCheck &&
                    !PlayingPieces [x1, y1].Moving &&
                    !PlayingPieces [x2 + 1, y2].Moving &&
                    !PlayingPieces [x2 + 2, y2].Moving &&
    ...
    internal bool CheckTileMatchY (int x1, int y1, int x2, int y2, bool justCheck)
    {
        ...
        if ((gridDescriptor [x2, y2] != (int)TileType.NoTile) &&
            ...
            if (((y2 + 2) < rows) &&
                ...
                ((intGridDescriptor [x2, y2] == intGridDescriptor [x2, y2 + 1]) || PlayingPieces [x2, y2 + 1].Bomb) &&
                ((intGridDescriptor [x2, y2] == intGridDescriptor [x2, y2 + 2]) || PlayingPieces [x2, y2 + 2].Bomb)) {
                if (!justCheck &&
                    !PlayingPieces [x1, y1].Moving &&
    ...
    internal bool CheckTileMatchY4 (int x1, int y1, int x2, int y2, bool justCheck)
    {
        ...
        if ((gridDescriptor [x2, y2] != (int)TileType.NoTile) &&
            ...
            if (((y2 + 3) < rows) &&
                ...
                ((intGridDescriptor [x2, y2] == intGridDescriptor [x2, y2 + 1]) || PlayingPieces [x2, y2 + 1].Bomb) &&
                ((intGridDescriptor [x2, y2] == intGridDescriptor [x2, y2 + 2]) || PlayingPieces [x2, y2 + 2].Bomb) &&
                ((intGridDescriptor [x2, y2] == intGridDescriptor [x2, y2 + 3]) || PlayingPieces [x2, y2 + 3].Bomb)) {
                if (!justCheck &&
                    !PlayingPieces [x1, y1].Moving &&
                    !PlayingPieces [x2, y2 + 1].Moving &&
                    !PlayingPieces [x2, y2 + 2].Moving &&
    ...
    private Point GetNextSlidingPosition(int x, int y)
    {
        ...
        p.x = -1;
        p.y = -1;
        if ((y + 1) < rows && gridDescriptor [x, y + 1] != (int)TileType.NoTile && gridDescriptor [x, y + 1] != (int)TileType.BlockedTile && PlayingPieces [x, y + 1] == null)
        { // Just down
            p.x = x;
            p.y = y + 1;
        }
        else if ((x - 1) >= 0 && (y + 1) < rows && gridDescriptor [x - 1, y + 1] != (int)TileType.NoTile && gridDescriptor [x - 1, y + 1] != (int)TileType.BlockedTile && PlayingPieces [x - 1, y + 1] == null)
        {// down left
            p.x = x - 1;
            p.y = y + 1;
        }
        else if ((x + 1) < columns && (y + 1) < rows && gridDescriptor [x + 1, y + 1] != (int)TileType.NoTile && gridDescriptor [x + 1, y + 1] != (int)TileType.BlockedTile && PlayingPieces [x + 1, y + 1] == null)
        {// down right
            p.x = x + 1;
            p.y = y + 1;
        }
